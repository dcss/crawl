...

{
    ...
    { {AT_TAIL_SLAP, AF_PLAIN, 14}, {AT_BITE, AF_DRAG, 27}, AT_NO_ATK,
       AT_NO_ATK },
    12, 620,
...

{
    ...
    { {AT_RANDOM, AF_PLAIN, 55}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 820,
...
{
    MONS_REGAL, 'X', LIGHTMAGENTA, "Regal",
    M_NO_SKELETON | M_SEE_INVIS | M_SPEAKS | M_UNIQUE | M_MALE | M_NO_POLY_TO,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2),
    35, MONS_OCTOPODE, MONS_OCTOPODE, MH_NATURAL, 140,
    { {AT_TENTACLE_SLAP, AF_PLAIN, 24}, {AT_CONSTRICT, AF_CRUSH, 5},
       AT_NO_ATK, AT_NO_ATK },
    18, 1440,
    10, 14, MST_REGAL, true, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_MISC,
    {TILEP_MONS_OCTOPODE}, TILE_CORPSE_OCTOPODE
},
